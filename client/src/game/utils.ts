...
export function platformCollision (object1: hitboxType | hitboxSmallType, object2: ICollusionBlock): boolean {
  return (
    object1.position.y + object1.height >= object2.position.y &&
...
export function xCollusion (object1: hitboxType | hitboxSmallType, object2: ICollusionBlock | SpriteBase): boolean {
  return (
    object1.position.x <= object2.position.x + object2.width &&
    object1.position.x + object1.width >= object2.position.x
  );
